...
.factory('taBrowserTag', [function(){
	...
	var taFixChrome = function(html){
		...
		while(match = spanMatch.exec(html)){
			...
			if(styleVal && styleVal.match(/line-height: 1.[0-9]{3,12};|padding:[0-9]{3,12}px;|color: inherit; line-height: 1.1;|color: rgb\(\d{1,3}, \d{1,3}, \d{1,3}\);|background-color: rgb\(\d{1,3}, \d{1,3}, \d{1,3}\);/i)){
